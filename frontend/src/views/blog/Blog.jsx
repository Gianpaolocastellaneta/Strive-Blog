    ...
    return (
      <div className="blog-details-root">
        <Container>
          ...
          <div className="blog-details-container mb-5">
          ...
          ></div>
          <div className="mt-5 blog-details-comments">Post Comments</div>
          
          {comments.map((comment, i) => (
          <Col
          key={`item-${i}`}
          md={10} className="mb-3"
          style={{
            marginBottom: 20,
          }}
        >
          <div className="d-flex justify-content-between mt-2 px-3 py-3 border border-secondary rounded bg-light">
          <div className="  ">
            {comment.content}
            </div> 
          <BlogAuthor {...blog.author}  />
